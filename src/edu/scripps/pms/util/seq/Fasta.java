...
public class Fasta implements Comparable<Fasta> {
    ...
    private boolean addedDefLines = false;

    public boolean isAddedDefLines() {
        return addedDefLines;
    }

    public void setAddedDefLines(boolean addedDefLines) {
        this.addedDefLines = addedDefLines;
    }
