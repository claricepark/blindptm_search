...
public class IniFile {
	...
	try {
		...
		CurrentDirectory = new File(Parser.nextToken());
		...
		while (LineBuffer != null) {
			...
			Parser = new StringTokenizer(LineBuffer);
			Parser.nextToken();
			UseDepthCGI = new Boolean(Parser.nextToken()).booleanValue();
		    }
			...
			Parser = new StringTokenizer(LineBuffer);
			Parser.nextToken();
			LocusLengthCutoff = new Integer(Parser.nextToken()).intValue();
		    }
			...
			System.out.println("Didn't understand this line in DTASelect.ini:");
