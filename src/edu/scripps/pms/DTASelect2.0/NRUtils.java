...
System.out.println("indxc: " + indxc.length + "indxr: " + indxr.length + "\ta: " + a.length + "\ta[0]: " + a[0].length + "\tn: " + n);
        for (l=n-1; l>-1; l--) {
            if (indxr[l] != indxc[l]) {
                for (k=1; k<=n; k++) {
System.out.println("l: " + l + "\tk: " + k + "\tindex[]: " + indxr.length + "\ta: " + a.length + "\ta[0]: " + a[0].length );
